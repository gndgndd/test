...
class PennChord : public PennApplication
{
  public:
    ...
    // Renamed IsInBetween for clarity in the implementation file
    ...
    // **NEW/FIXED:** Key transfer signalling mechanism
    void TransferKeys(Ipv4Address newOwner, Ipv4Address oldOwner);
