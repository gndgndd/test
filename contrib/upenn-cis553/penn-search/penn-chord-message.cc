...
uint32_t PennChordMessage::PingReq::Deserialize (Buffer::Iterator &start) { uint16_t length = start.ReadU16 (); char* str = (char*) malloc (length); start.Read ((uint8_t*)str, length); pingMessage = std::string (str, length); free (str); return PingReq::GetSerializedSize (); }
...
uint32_t PennChordMessage::PingRsp::Deserialize (Buffer::Iterator &start) { uint16_t length = start.ReadU16 (); char* str = (char*) malloc (length); start.Read ((uint8_t*)str, length); pingMessage = std::string (str, length); free (str); return PingRsp::GetSerializedSize (); }
...
void PennChordMessage::LookupReq::Print (std::ostream &os) const { os << "LookupReq:: lookupKey=" << lookupKey << " originator=" << originator << " lastHop=" << lastHop << "\n"; }
...
void PennChordMessage::LookupForward::Print (std::ostream &os) const { os << "LookupForward:: lookupKey=" << lookupKey << " originator=" << originator << " lastHop=" << lastHop << "\n"; }
...
void PennChordMessage::LookupRsp::Print (std::ostream &os) const { os << "LookupRsp:: lookupKey=" << lookupKey << " ownerNode=" << ownerNode << "\n"; }
...
void PennChordMessage::StabilizeReq::Print (std::ostream &os) const { os << "StabilizeReq:: Requesting Node =" << requestingNode << "\n"; }
...
void PennChordMessage::StabilizeRsp::Print (std::ostream &os) const { os << "StabilizeRsp:: Predessor of responding node =" << responsePredessor << "\n"; }
...
void PennChordMessage::NotifyMsg::Print (std::ostream &os) const { os << "NotifyMsg:: Potential new predessor =" << potentialPredessor << "\n"; }
