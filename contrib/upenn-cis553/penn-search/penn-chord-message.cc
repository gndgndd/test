...
uint32_t
PennChordMessage::StabilizeReq::GetSerializedSize () const
{
  return IPV4_ADDRESS_SIZE;
}
...
{
  os << "StabilizeReq:: Requesting Node =" << requestingNode << "\n";
}

void
PennChordMessage::StabilizeReq::Serialize (Buffer::Iterator &i) const
{
  i.WriteHtonU32 (requestingNode.Get ());
}

uint32_t
PennChordMessage::StabilizeReq::Deserialize (Buffer::Iterator &i)
{
  requestingNode = Ipv4Address(i.ReadNtohU32 ());
  return GetSerializedSize ();
}

uint32_t
PennChordMessage::StabilizeRsp::GetSerializedSize () const
{
  return IPV4_ADDRESS_SIZE;
}
...
{
  os << "StabilizeRsp:: Predessor of responding node =" << responsePredessor << "\n";
}

void
PennChordMessage::StabilizeRsp::Serialize (Buffer::Iterator &i) const
{
  i.WriteHtonU32 (responsePredessor.Get ());
}

uint32_t
PennChordMessage::StabilizeRsp::Deserialize (Buffer::Iterator &i)
{
  responsePredessor = Ipv4Address(i.ReadNtohU32 ());
  return GetSerializedSize ();
}

uint32_t
PennChordMessage::NotifyMsg::GetSerializedSize () const
{
  return IPV4_ADDRESS_SIZE;
}

void
PennChordMessage::NotifyMsg::Print (std::ostream &os) const
{
  os << "NotifyMsg:: Potential new predessor =" << potentialPredessor << "\n";
}

void
PennChordMessage::NotifyMsg::Serialize (Buffer::Iterator &i) const
{
  i.WriteHtonU32 (potentialPredessor.Get ());
}

uint32_t
PennChordMessage::NotifyMsg::Deserialize (Buffer::Iterator &i)
{
  potentialPredessor = Ipv4Address(i.ReadNtohU32 ());
  return GetSerializedSize ();
}
...
void
PennChordMessage::SetStabilizeReq (Ipv4Address requestor)
{
  m_messageType = STABILIZE_REQ;
  m_message.stabilizeReq.requestingNode = requestor;
}
...
void
PennChordMessage::SetStabilizeRsp (Ipv4Address pred)
{
  m_messageType = STABILIZE_RSP;
  m_message.stabilizeRsp.responsePredessor = pred;
}

PennChordMessage::NotifyMsg
PennChordMessage::GetNotifyMsg ()
{
  return m_message.notifyMsg;
}

void
PennChordMessage::SetNotifyMsg (Ipv4Address potPred)
{
  m_messageType = NOTIFY_MSG;
  m_message.notifyMsg.potentialPredessor = potPred;
}
