      ...
      struct StabilizeReq
        {
          ...
          Ipv4Address requestingNode;     // Node requesting its successor's predessor
        };
      ...
      struct StabilizeRsp
        {
          ...
          Ipv4Address responsePredessor;     // Current predessor of the response node
        };
      ...
      struct NotifyMsg
        {
          ...
          Ipv4Address potentialPredessor;     // Possible predessor to update
        };
